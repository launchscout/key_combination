defmodule KeyCombinationWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KeyCombinationWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KeyCombinationWeb.Gettext, "errors", msg, opts)
    end
  end
